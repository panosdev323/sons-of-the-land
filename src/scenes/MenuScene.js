...
export class MenuScene extends Phaser.Scene {
  ...
  async create() {
    ...
    this.add.text(w / 2, 272, `Drag on empty areas (left/right of buttons) to scroll and view all civilizations`, {
    ...
    civs.forEach((civ, i) => {
      ...
      const emojiText = this.add.text(x - 130, y, civ.emoji, { fontSize: '24px' }).setOrigin(0.5)
